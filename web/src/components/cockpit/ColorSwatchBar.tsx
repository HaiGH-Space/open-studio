  ...
  if (activeSwatches.length === 0) {
    return (
      ...
      >
        ...
        >
          <div
            className={cn(sizeClasses[size], "border-border/40 bg-muted/30")}
          />
          <div
            className={cn(sizeClasses[size], "border-border/40 bg-muted/20")}
          />
          <div
            className={cn(sizeClasses[size], "border-border/40 bg-muted/10")}
          />
        </div>
      </div>
    )
      ...
      {activeSwatches.map((item) => (
        ...
        >
          <div
            className={cn(
              sizeClasses[size],
              "shrink-0 border-black/20 shadow-2xs transition-transform group-hover:scale-110 dark:border-white/20"
            )}
